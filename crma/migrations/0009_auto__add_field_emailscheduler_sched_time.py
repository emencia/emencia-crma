...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailScheduler.sched_time'
        db.add_column(u'crma_emailscheduler', 'sched_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailScheduler.sched_time'
        db.delete_column(u'crma_emailscheduler', 'sched_time')
    ...
    models = {
        ...
        u'crma.emailscheduler': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            'sched_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
