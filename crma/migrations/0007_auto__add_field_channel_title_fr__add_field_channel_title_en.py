...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channel.title_fr'
        db.add_column(u'crma_channel', 'title_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Channel.title_en'
        db.add_column(u'crma_channel', 'title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channel.title_fr'
        db.delete_column(u'crma_channel', 'title_fr')

        # Deleting field 'Channel.title_en'
        db.delete_column(u'crma_channel', 'title_en')
