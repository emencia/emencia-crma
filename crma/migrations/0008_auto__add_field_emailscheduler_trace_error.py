...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailScheduler.trace_error'
        db.add_column(u'crma_emailscheduler', 'trace_error',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailScheduler.trace_error'
        db.delete_column(u'crma_emailscheduler', 'trace_error')
