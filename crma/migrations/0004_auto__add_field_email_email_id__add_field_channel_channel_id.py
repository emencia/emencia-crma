...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Email.email_id'
        db.add_column(u'crma_email', 'email_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Channel.channel_id'
        db.add_column(u'crma_channel', 'channel_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Email.email_id'
        db.delete_column(u'crma_email', 'email_id')

        # Deleting field 'Channel.channel_id'
        db.delete_column(u'crma_channel', 'channel_id')
